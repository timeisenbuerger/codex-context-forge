...
export const techStackValidationCommands: Record<string, ValidationCommandSet> = {
  ...
  'compose-multiplatform': {
    ...
    build: './gradlew build',
    start: './gradlew :composeApp:run',
    typeCheck: './gradlew compileKotlin',
    lint: './gradlew ktlintCheck',
    format: './gradlew ktlintFormat',
    coverage: './gradlew koverHtmlReport',
    security: ['./gradlew dependencyCheckAnalyze', './gradlew detekt'],
  },
};
...
export function getValidationCommands(techStack: ProjectConfig['techStack']): ValidationCommandSet {
  ...
  // Handle Compose Multiplatform specifically
  if (frontend === 'compose-multiplatform') {
    return techStackValidationCommands['compose-multiplatform'];
  }
