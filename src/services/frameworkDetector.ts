  ...
  private initializePatterns(): FrameworkPattern[] {
    return [
      ...
      // Compose Multiplatform
      {
        ...
        files: ['gradle.properties', 'build.gradle.kts', 'settings.gradle.kts'],
        content: [
          { file: 'build.gradle.kts', pattern: /kotlin\("multiplatform"\)/, weight: 25 },
          { file: 'build.gradle.kts', pattern: /id\("org\.jetbrains\.compose"\)/, weight: 30 },
          { file: '**/*.kt', pattern: /@Composable/, weight: 20 },
          {
            file: 'gradle.properties',
            pattern: /kotlin\.mpp\.enableCInteropCommonization/,
            weight: 15,
          },
          {
            file: 'build.gradle.kts',
            pattern: /org\.jetbrains\.kotlin\.multiplatform/,
            weight: 25,
          },
          { file: '**/*.kt', pattern: /import androidx\.compose/, weight: 15 },
          { file: '**/*.kt', pattern: /import org\.jetbrains\.compose/, weight: 15 },
        ],
        structure: ['src/commonMain', 'src/androidMain', 'src/iosMain'],
        priority: 95,
        variants: [
          {
            name: 'desktop-only',
            files: ['src/jvmMain'],
            content: [{ file: 'build.gradle.kts', pattern: /application\s*\{/, weight: 15 }],
          },
          {
            name: 'mobile-focused',
            files: ['src/androidMain', 'src/iosMain'],
            content: [
              { file: 'build.gradle.kts', pattern: /android\s*\{/, weight: 10 },
              { file: 'build.gradle.kts', pattern: /iosX64\(\)/, weight: 10 },
            ],
          },
          {
            name: 'full-multiplatform',
            files: [
              'src/commonMain',
              'src/androidMain',
              'src/iosMain',
            ...
            content: [
              { file: 'build.gradle.kts', pattern: /js\(IR\)\s*\{/, weight: 10 },
              { file: 'build.gradle.kts', pattern: /wasmJs\s*\{/, weight: 10 },
            ],
          },
          {
            name: 'web-enabled',
            files: ['src/jsMain', 'src/wasmJsMain'],
            content: [
              { file: 'build.gradle.kts', pattern: /js\(IR\)/, weight: 15 },
              { file: 'build.gradle.kts', pattern: /wasmJs/, weight: 15 },
            ],
          },
        ],
      },
